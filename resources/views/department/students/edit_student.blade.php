                                ...
                                <form method="POST" action="{{ route('allstudents.update', $student->id) }}">
                                    ...
                                    <div class="col-6 col-12-xsmall formin">
                                        <input id="surname" class="block mt-1 w-full" type="text" name="surname"
                                            value="{{ $student->surname }}" placeholder="Surname" required autofocus />
                                    </div>
                                    ...
                                    <!-- Matric No. -->
                                    <label class="block font-medium text-sm text-white-700" for="matric">Matric No.</label>
                                    <div class="col-6 col-12-xsmall formin">
                                        <input id="matric" class="block mt-1 w-full" type="text" name="matric"
